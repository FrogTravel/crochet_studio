...
A thin, testable wrapper around ``google-genai`` so the rest of the
pipeline never imports that dependency directly.
"""
...
def generate_image(
    ...
    ------
    RuntimeError
        When no image data is returned or the API call fails.
    """
